...
import com.photosharing.payload.response.JWTResponse;
import com.photosharing.payload.response.MessageResponse;
import com.photosharing.security.jwt.JWTUtil;
import com.photosharing.service.impl.RoleService;
...
public class AuthenticationAPI {
	...
	public ResponseEntity<?> authenticationUser(@Valid @RequestBody UserDTO requestUserDTO) {
		...
		List<String> roles = userDTO.getAuthorities().stream().map(item -> item.getAuthority())
